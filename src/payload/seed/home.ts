    ...
    richText: [
      {
        children: [
          {
            text: 'Tech Haven E-Commerce Store',
          },
        ],
        type: 'h1',
      },
      {
        children: [
          ...
          {
            text: " Tech Haven's e-commerce platform offers a seamless blend of cutting-edge technology and user-friendly design for an exceptional online shopping experience",
          },
          {
            type: 'link',
            linkType: 'custom',
